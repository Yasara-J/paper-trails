<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container">
        <a class="navbar-brand" href="#"><span class="fw-bolder text-danger" style="font-size: 30px;">Paper </span><span class="fw-bolder text-warning" style="font-size: 30px;">Trails</span></a>
        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <a class="nav-link active" aria-current="page" href="#"  data-bs-toggle="modal" data-bs-target="#termModal" >Terms and Conditions</a>
            </li>
        </ul>
            ...
            <div class="modal-dialog modal-xl">
              <div class="modal-content">
                ...
                <div class="modal-body">
                    <h1 class="text-center">Terms and Conditions - Paper Trails</h1>
                    <hr/>
                    <br/>
        ...
        <form class="d-flex">
            ...
            <button class="btn text-uppercase" type="button">Wishlist</button>&nbsp;&nbsp;
            <button class="btn text-uppercase" type="button">Cart</button>&nbsp;&nbsp;
